...
6/8/24 8:00
## Purpose
Continue work on expressions
## Ownership
+ ~100 = ~700
## Outcomes
- Created methods for verifying that a String is a valid expression
## End Time
6/8/24 10:00
...
6/9/24 6:00
## Purpose
Complete expression and function evaluation needs
## Ownership
+ ~150 = ~850
## Outcomes
- Created methods for evaluating expressions
- Created methods for evaluating functions
## End Time
6/9/24 12:00
...
6/11/24 7:00
## Purpose
Write tests for WelcomePageController and SheetSelectPageController
## Ownership
+ ~50 = 900
## Outcomes
- Ran into trouble with a strange error that I was unable to figure out and overcome
## End Time
6/9/24 8:30
...
6/12/24 4:30
## Purpose
Figure out testing error ExceptionInInitializerError occuring in WelcomePageController and SheetSelectPageController
## Outcomes
- Figured out and solved the error occuring from one part of the code only to be stuck again when it frustatingly immediately just shifted farther down the stack trace where the error was occuring
## End Time
6/9/24 6:00
...
6/14/24 2:00
## Purpose
Finish tests and make sure to finalize everything for project submission
## Ownership
+ ~350 = 1250
## Outcomes
- Was again unable to solve the testing error but I wrote tests for each function just to show that the work was done but its just not working for an unknown reason
- Added ownership to relevant files
- Completed exit interview google form
## End Time
6/4/24 12:00
